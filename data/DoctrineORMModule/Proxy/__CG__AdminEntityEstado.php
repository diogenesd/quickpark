 ...
 */
class Estado extends \Admin\Entity\Estado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Entity\\Estado' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\Estado' . "\0" . 'uf', '' . "\0" . 'Admin\\Entity\\Estado' . "\0" . 'descricao', '' . "\0" . 'Admin\\Entity\\Estado' . "\0" . 'ativo', '' . "\0" . 'Admin\\Entity\\Estado' . "\0" . 'municipios');
        }
     ...
     * {@inheritDoc}
     */
    public function setMunicipios(\Doctrine\Common\Collections\ArrayCollection $municipios)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMunicipios', array($municipios));

        return parent::setMunicipios($municipios);
    }
